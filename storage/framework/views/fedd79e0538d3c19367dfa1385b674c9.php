    ...
    <form action="<?php echo e(route('categories.goals.store', $category->id)); ?>" method="POST">
        ...
        <div class="mb-5">
            ...
            <div class="mb-3" id="tasks">
                ...
                <?php if(old('tasks')): ?>
                    <?php $__currentLoopData = old('tasks'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="input-group mb-2">
                            <div class="input-group-text">
                                <input type="checkbox" name="checked[<?php echo e($index); ?>]" value="1">
                            </div>
...
<?php /**PATH F:\pedro\Documents\goal-mind\resources\views/goals/create.blade.php ENDPATH**/ ?>